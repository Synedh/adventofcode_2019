...
def execute(opcode, arg1, arg2, out_id, i):
    if opcode == 1:
...
def compute_instruction(i):
    ...
    return opcode, arg1, arg2, out_id, i


data = [int(v) for v in open('input').readline().split(',')]
i = 0
while data[i] != 99:
    opcode, arg1, arg2, out_id, i = compute_instruction(i)
    execute(opcode, arg1, arg2, out_id, i)